...
// Synthèse 2 : jamais pré-écrite, jamais un feedback évaluatif — pure continuité
// de fiction, en réaction à ce que l'étudiant·e a répondu à la Synthèse 1.
// Depuis le 31/08, elle enchaîne sur `synthese1Text` (la scène réellement jouée)
// et non plus sur `palierC.text` (l'indication de mise en scène).
